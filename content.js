...
(async () => {
  ...
  const setStatusToConnected = () => {
    ...
    if (typeof injectedGlue !== 'undefined') {
      tooltipElement.textContent = `Extension: Glue42 Gmail connector; Version: ${injectedGlue.version}; Username: ${injectedGlue.connection.resolvedIdentity.user}; GW URL: ${injectedGlue.config.connection.ws};`;
    }
  };
